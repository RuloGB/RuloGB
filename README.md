...
Full stack developer, 15+ years shipping web applications in Java, Spring Boot, Angular, Vue and Node.js. These days I spend most of my time building developer tooling for the AI era: RAG systems, MCP servers and agent infrastructure.

I care about the boring parts — TDD, DDD, code that still reads well ten years later. Everything below sits between those habits and LLM agents.
...
Java · Spring Boot · Microservices · TypeScript · Node.js · Angular · Vue · Svelte · Rust · Tauri · Docker · Kubernetes · PostgreSQL · AWS, Azure and GCP
